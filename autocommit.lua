...
function commit()
	...
	os.execute('cp -v "C:/Users/Dwayne/Games/MCForge/1.6.2_804/forge/mcp/src/minecraft/assets" assets')
	os.execute('cp -v "C:/Users/Dwayne/Games/MCForge/1.6.2_804/forge/mcp/src/minecraft/ds" ds')
	os.execute('git add .')
